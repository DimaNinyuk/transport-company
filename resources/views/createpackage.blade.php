...
<div class="subnavbar">
    ...
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                <li class="active"><a><i class="icon-plus-sign"></i><span>Добавить отправление</span> </a> </li>
        </div>
        <!-- /container -->
    </div>
    <!-- /subnavbar-inner -->
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="jscontrols">
                                <form id="edit-profile" action="{{ url('/add-package') }}" method="POST" class="form-horizontal">
                                @csrf
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="span6" name="TrackNumber" value="">
