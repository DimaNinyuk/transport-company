...
<div class="subnavbar">
    ...
    <div class="subnavbar-inner">
        <div class="container">
            <ul class="mainnav">
                <li class="active"> <a><i class="icon-plus-sign"></i><span>Добавить продукт</span> </a> </li>
        </div>
        <!-- /container -->
    </div>
    <!-- /subnavbar-inner -->
                    ...
                    <div class="tabbable">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="jscontrols">
                                <form id="edit-profile" action="{{ url('/add-product') }}" method="POST" class="form-horizontal">
                                @csrf
                                    <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-prepend input-append">
                                                        ...
                                                        <input class="span2" id="appendedPrependedInput" type="text" name="Price" value="">
